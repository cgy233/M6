...
void LED_Init(void)
{
	...
	HAL_GPIO_WritePin(GPIOA, GPIO_LED_0 | GPIO_LED_POUND, GPIO_PIN_CLEAR);
	HAL_GPIO_WritePin(GPIOC, GPIO_LED_1 | GPIO_LED_4 | GPIO_LED_5 | GPIO_LED_8 | GPIO_LED_START , GPIO_PIN_CLEAR);
	HAL_GPIO_WritePin(GPIOE, GPIO_LED_START | GPIO_LED_2 | GPIO_LED_6 | GPIO_LED_7 | GPIO_LED_9, GPIO_PIN_CLEAR);
	HAL_GPIO_WritePin(GPIOE, GPIO_LED_3, GPIO_PIN_CLEAR);
	delay_ms(1);
