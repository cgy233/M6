...
* Return         : None
**************************************************************************/
void SHA256_transform (UINT32 *state, uint8_t *block);
...
* Return         : None
**************************************************************************/
void SHA256_update (SHA256_CTX *context, uint8_t *input,UINT32 inputLen);
...
* Return         : None
**************************************************************************/
void SHA256_final (uint8_t *digest, SHA256_CTX *context);
...
* Return         : None
**************************************************************************/
void SHA256_hash(uint8_t *pDataIn,UINT32 DataLen,uint8_t *pDigest);
